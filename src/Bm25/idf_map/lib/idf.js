/*
 * Fcn to compute the inverse document frequency of some input term.
 */
module.exports = (function() {
  ...
  return function(term, termFreqMaps) {
            ...
            for(let i in termFreqMaps) {
              // Loop over docs in corpus, increment by 1 if term is seen 
              // in a given doc.
              docsAppear += ( termFreqMaps[i].hasOwnProperty(term) ? 1 : 0 );
            }
            // Add 1 to log to shift log curve above 0 so that terms are 
            // guaranteed strictly positive weight.
            // Add 1 in denominator to prevent division by 0 when a term 
            // doesn't appear in a document.
